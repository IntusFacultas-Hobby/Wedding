...
.weddingparty__container {
  display: flex;
  flex-direction: column;
  justify-content: flex-start;
  align-items: center;
}
.weddingparty__container__item {
  display: flex;
  flex-direction: row;
  flex-wrap: wrap;
  margin: 0.5em 0;
...
.weddingparty__container__item__text {
  display: flex;
  flex-direction: column;
  padding: 1em;
  text-align: left;
